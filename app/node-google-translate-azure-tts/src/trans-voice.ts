...
import { GetLanguage, GetXTime } from './util/util.js';
...
app.get('/TransVoice', async (req, res) =>
{
    ...
    const from: 'zh-CN' | 'en-US' = GetLanguage(trans_word) ? 'zh-CN' : 'en-US';
    ...
    let final_data: Buffer = Buffer.alloc(0);
